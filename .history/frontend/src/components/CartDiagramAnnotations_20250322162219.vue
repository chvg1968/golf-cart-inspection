...
const selectLineWidth = (width: number) => {
  ...
  if (drawingContext.value) {
    drawingContext.value.lineWidth = width
  }
}
...
const renderColorReference = () => {
  ...
  titleElement.textContent = 'Color Reference'
  titleElement.style.fontWeight = 'bold'
  referenceContainer.appendChild(titleElement)

  // Crear elementos de referencia de color
