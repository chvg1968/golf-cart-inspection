...
import { CART_PARTS, CartPartCategory, DAMAGE_TYPES } from '@/constants'
import type { 
  Damage, 
...
const selectedCategory = ref<CartPartCategoryType>(CartPartCategory.EXTERIOR)

const categories = [
  CartPartCategory.EXTERIOR,
  CartPartCategory.INTERIOR,
  CartPartCategory.SEATS,
  CartPartCategory.MECHANICAL,
  CartPartCategory.OTHER
]
