  ...
  setup() {
    ...
    const isFormValid = computed(() => {
      ...
      console.log('isFormValid check:', {
        ...
        damagesLength: damages.value.length,
        basicInfoValid,
        damagesValid,
        result: basicInfoValid && damagesValid
      })
    ...
    const addDamage = (newDamage) => {
      console.log('NewInspection addDamage:', { newDamage, currentDamages: [...damages.value] })
      damages.value.push(newDamage)
      console.log('After push:', { damages: [...damages.value] })
    }
