...
import { CART_PARTS, PROPERTY_OPTIONS, CART_TYPE_OPTIONS, DAMAGE_TYPES } from '@/constants'
import { 
  Damage, 
  CartTypeOption, 
  DamageType,
...
const propertyOptions = ref(PROPERTY_OPTIONS)
const cartTypeOptions = ref<CartTypeOption[]>(CART_TYPE_OPTIONS)
