...
// Función para generar el PDF del formulario
...
const submitForm = async (formData: FormData & { pdfBase64: string; damageRecords: DamageRecord[] }) => {
  try {
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(date: Date | undefined) => setValue("date", date || null)}
