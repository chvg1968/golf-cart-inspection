...
DATABASES = {
    'default': {
        'ENGINE': os.getenv('DB_ENGINE', 'django.db.backends.postgresql'),  # Asegura que el motor por defecto sea PostgreSQL
        'NAME': os.getenv('DB_NAME'),  # Elimina el fallback a SQLite
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Golf Cart Inspection <noreply@example.com>')
