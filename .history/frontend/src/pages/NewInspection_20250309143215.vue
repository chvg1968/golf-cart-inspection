...
console.log('NewInspection Component: Initializing')
...
const submitInspection = async () => {
  try {
    ...
    const inspectionData = {
      ...
      terms_accepted: true  // Siempre true para este caso
    }

    console.log('Sending Inspection Data:', JSON.stringify(inspectionData, null, 2))

    // Configuración de axios para depuración
    ...
    console.log('Inspection Creation Response:', response.data)
